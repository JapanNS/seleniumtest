...
public class TestActionsClass {
    ...
    public void simpleForm() {
        ...
        current.sendKeys("Aoba-ku, Katahira 1 chome, 4-23");
        // Select, copy and paste

        Actions action = new Actions(driver);
        // select syntax
        // every single actions needs to be finished with "perform"
        current.click();
        action.keyDown(current, Keys.COMMAND + "a").keyUp(Keys.COMMAND).perform();
        current.click();
